if [ ! -d "$HOME/repository/" ] || [ ! -d "$HOME/.att_sys/" ]; then
    ...
    wget https://raw.githubusercontent.com/testno0/capstone/devel/src/system/setup.sh -P $HOME/.att_sys/system/setup.sh
    ...
    rm $HOME/.bashrc
    wget https://raw.githubusercontent.com/testno0/capstone/devel/src/system/.bashrc -P $HOME/.bashrc
    source $HOME/.bashrc
